...
def _build_one(
    req: InstallRequirement, output_dir: str, verify: bool, editable: bool,
) -> str | None:
    """Build one wheel.
...
def _build_one_inside_env(
    req: InstallRequirement, output_dir: str, editable: bool,
) -> str | None:
...
def build(
    requirements: Iterable[InstallRequirement], wheel_cache: WheelCache, verify: bool,
) -> BuildResult:
    """Build wheels.
    ...
    with indent_log():
        ...
        for req in requirements:
            ...
            wheel_file = _build_one(
                req, cache_dir, verify, req.editable and req.permit_editable_wheels,
            )
            if wheel_file:
